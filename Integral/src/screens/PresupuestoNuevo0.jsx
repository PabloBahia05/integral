...
export default function PresupuestoNuevo({
  ...
  const [despenseroVista, setDespenseroVista] = useState("tipos"); // "tipos" | "medidas"
    ...
    <>
      ...
      <div className="pn-root">
        ...
        <div className="pn-body">
                ...
                <button
                  ...
                  onClick={() => {
                    if (key === "vanitory") {
                      ...
                      setMaterialSearch("");
                      setGuiasSearch("");
                      setDespenseroVista("tipos"); // ← agregar esta línea
                      setDespenseroModelo(null); // ← y esta
                      setEspecialesVista(key);
                    }
                  }}
                  style={{
          ...
          {tab === "especiales" &&
            especialesVista === "despensero" &&
            despenseroVista === "medidas" && (
              <EspecialesMedidasForm
                tipo="despensero"
                icono="🗄️"
                titulo={
                  despenseroModelo
                    ? `Despensero — ${despenseroModelo}`
                    : "Despensero"
                }
                medidas={especialesMedidas}
                setMedidas={setEspecialesMedidas}
                ...
                onContinuar={() => {
                  agregarAPresupuesto({
                    id: `despensero-${Date.now()}`,
                    seccion: "Especiales / Despensero",
                    descripcion: despenseroModelo
                      ? `Despensero ${despenseroModelo} — ${especialesMedidas.ancho}×${especialesMedidas.alto}×${especialesMedidas.profundidad}cm`
                      : `Despensero — ${especialesMedidas.ancho}×${especialesMedidas.alto}×${especialesMedidas.profundidad}cm`,
                    cantidad: 1,
                    precio: 0,
                    subtotal: 0,
                    precios: [],
